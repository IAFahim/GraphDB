...
{
    public class GDBAsset : ScriptableObject
    {
        ...
        public List<CombatState> CombatStates = new List<CombatState>();
        public List<Description> Descriptions = new List<Description>();
        public List<Economy> Economys = new List<Economy>();
        public List<EconomyState> EconomyStates = new List<EconomyState>();
        public List<Effect> Effects = new List<Effect>();
        public List<EffectState> EffectStates = new List<EffectState>();
        public List<Equipment> Equipments = new List<Equipment>();
        public List<Guild> Guilds = new List<Guild>();
        public List<GuildState> GuildStates = new List<GuildState>();
